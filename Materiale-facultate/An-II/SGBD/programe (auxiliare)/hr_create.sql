...
create table WORKS_ON(
	project_id number(4) references projects(project_id),
	employee_id number(6) references employees(employee_id),
	start_date date, 
	end_date date,
	primary key(project_id, employee_id));
	
insert into projects values (1, 'ALFA', 20000, '2-JAN-2006', '30-MAR-2006', '7-APR-2006', 102);
insert into projects values (2, 'BETA', 10000, '5-MAY-2006', '15-JUL-2006', '15-JUL-2006', 103); 
insert into projects values (3, 'GAMA', 10000, '11-DEC-2006', '15-JAN-2007', '17-JAN-2007', 102); 
